...
public class EstimateService {
    ...
    public void registerOrder(UserOrderDto dto) {
        ...
        packageList.add(new CustomerPackage(customer.getCustomerId(), PackageType.REFRIGERATOR.getCode(), dto.getRefrigerator()));
    ...
    public Integer getPrice(UserOrderDto dto) {
        ...
        int pricePerTruck_4tons = boxes/200;  //200:4トントラックの上限積載量
        int rem_boxes = estimateDAO.getPricePerTruck(boxes%200);
        int pricePerTruck = pricePerTruck_4tons*50000+rem_boxes;  //50000：4トントラックの価格
        ...
        int month = Integer.parseInt(dto.getSch_month());
        double month_n = 0;
        ...
        return (int)((priceForDistance + pricePerTruck)*month_n + priceForOptionalService);
    }
